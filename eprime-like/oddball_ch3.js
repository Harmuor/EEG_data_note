...
function InMindLoopBegin(InMindLoopScheduler, snapshot) {
  return async function() {
    ...
    for (const thisInMind of InMind) {
...
function RSVPListLoopBegin(RSVPListLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisRSVPList of RSVPList) {
...
function prepare_markerRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of prepare_markerComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function KeepInMindSlideRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of KeepInMindSlideComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function test_stimulusRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of test_stimulusComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function RSVP_2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of RSVP_2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function KeepInMindRecogRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of KeepInMindRecogComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function redo_or_notRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of redo_or_notComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function pretend_redoRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of pretend_redoComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
